...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow, WINDOW_WIDTH, WINDOW_HEIGHT):
        ...
        self.players = [
            CurrentPlayer("Vasilko", "path/to/square1.png", "path/to/vertical1.png", self.informations["Vasilko"]),
